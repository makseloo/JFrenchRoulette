...
public class WheelNumber implements Serializable {
	...
	public static List<Integer> numbers = Arrays.asList(32, 15, 19, 4, 21, 2, 25, 17, 34, 6, 27, 13, 36, 11, 30, 8, 23, 10, 5, 24, 16, 33, 1, 20, 14, 31, 9, 22, 18, 29, 7, 28, 12, 35, 3, 26,0);
	//dozens
	...
	public static List<Integer> getUp() {
		return up;
	}
	public static void setUp(List<Integer> up) {
		WheelNumber.up = up;
	}
	public static List<Integer> getDowns() {
		return downs;
	}
	public static void setDowns(List<Integer> downs) {
		WheelNumber.downs = downs;
	}
	public static List<Integer> getRight() {
		return right;
	}
	public static void setRight(List<Integer> right) {
		WheelNumber.right = right;
	}
